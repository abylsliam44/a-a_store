...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("shopNowBtn1").addEventListener("click", function() {
        window.location.href = "shop.html#clothing";
    });

    document.getElementById("shopNowBtn2").addEventListener("click", function() {
        window.location.href = "shop.html#shoes";
    });

    document.getElementById("shopNowBtn3").addEventListener("click", function() {
        window.location.href = "shop.html#tshirt";
    });
});
